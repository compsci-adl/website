# Cache package.json
FROM --platform=linux/arm64 node:18-bookworm-slim AS deps
...
# Build
FROM --platform=linux/arm64 node:18-bookworm-slim AS builder
...
FROM --platform=linux/arm64 node:18-bookworm-slim AS runner
