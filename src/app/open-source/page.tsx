                    ...
                    <section className="mb-8">
                        <div className="relative z-10 w-fit xl:ml-12">
                            ...
                            <div className="relative z-10 flex flex-row">
                                <div className="h-auto w-14 bg-orange" />
                                <div className="relative flex flex-col">
                                    <span className="relative bg-white py-4 pl-4 pr-16 text-2xl font-black text-black lg:pr-32 lg:text-4xl">
                                        Who is the
                                    </span>
                                    <span className="border-2 border-white py-6 pl-4 pr-16 text-2xl underline lg:pr-32 lg:text-4xl">
                                        Open Source Team?
                                    </span>
                                </div>
                            </div>
