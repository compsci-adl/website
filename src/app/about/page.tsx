                    ...
                    <div className="mb-10 mt-8 flex flex-col lg:justify-center">
                        ...
                        <div className="flex h-fit flex-row self-center border-b-2 border-t-2 border-white bg-grey px-4">
                            ...
                            <p className="my-4 text-lg md:text-xl">
                                ...
                                is a student-run club for those with an interest
                                in computer science or computing in general.
                                Although we&apos;re a university club, we
                                welcome anyone interested in computer science
                        ...
                        >
                            <Paragraph>
                                <ul className="ml-6 list-disc">
                                    ...
                                    <li>
                                        Frequent computer science talks on a
                                    ...
                                    <li>
                                        ...
                                        of other computer science students and
                                        graduates
                                    </li>
                                    <li>
                                        And of course,{" "}
                ...
                <section className="mt-10 flex flex-col gap-10 md:flex-row">
                    <div className="flex h-fit flex-row self-center border-b-2 border-t-2 border-white bg-grey px-4">
                        ...
                        <p className="my-4 text-lg lg:text-xl">
                            The club runs various competitions throughout the
                            year, offering members a chance to have fun and win
                            prizes. These have included programming and video
                            game competitions. The club also coordinates
                            projects among club members, allowing members to
                            gain valuable experience working on team projects —
                ...
                <section className="relative mt-8">
                    ...
                    <div className="relative rounded-xl border-2 border-white bg-grey px-4 py-4 md:px-6 md:py-6">
                        <p className="text-lg md:text-xl">
                            Founded in 2008 with a large and active group of
                            members, we are always willing to offer academic
                            assistance or make new friends. All are welcome to
                            join us for an exciting year in a fun, open and
                            unique environment.
                        </p>
                    </div>
                    <Image
                ...
                <section className="mt-8 md:mt-0">
                    <FancyRectangle colour="purple" offset="8" filled={false}>
                        <div className="w-fit bg-purple px-2 py-2">
                            <h2 className="text-4xl font-bold text-grey md:text-5xl">
                                FAQ
                            </h2>
                        </div>
                    </FancyRectangle>
                    ...
                    <div className="flex flex-col gap-x-16 gap-y-8 lg:flex-row">
                        ...
                        <div className="mb-8 mr-2 flex flex-col justify-items-center gap-12 lg:w-full">
                            ...
                            <FAQ
                                ...
                                answer={
                                    <p>
                                        You can register as a club member on our
                                        website{" "}
                                        <a href="/join" className="underline">
                                            here
                                        </a>
                                        . Create an account by filling in your
                                        information, then complete the payment
                            ...
                            <FAQ
                                ...
                                answer={
                                    <div>
                                        <p>
                                            Members will have access to the Duck
                                            Lounge, a diverse range of
                                            educational talks, workshops and
                                            resources, social nights, and a wide
                                            network of other computer science
                            ...
                            <FAQ
                                ...
                                answer={
                                    <p>
                                        Club membership costs $10 for the full
                                        year. You can pay for membership either
                                        online on our website, or in person at a
                                        club event or the Duck Lounge by
                                        speaking to one of the committee
                                        members.
                                    </p>
                                }
                                colour={"purple"}
                            ...
                            <FAQ
                                ...
                                answer={
                                    <p>
                                        The Duck Lounge is located at EM110 in
                                        the Engineering and Maths building. It
                                        has a study space with power outlets and
                                        couches, along with a Nintendo Switch
                                        for games. We also sell snacks and
                            ...
                            <FAQ
                                ...
                                answer={
                                    <p>
                                        ...
                                        where we post all club events and
                                        general discussions.
                                    </p>
                                }
                                colour={"yellow"}
                            ...
                            <FAQ
                                ...
                                answer={
                                    <p>
                                        ...
                                        to get in touch with us, visit our{" "}
                                        <a
                                            href="/contact"
                                            className="underline"
                                        >
