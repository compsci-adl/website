        ...
        <div className={`${className} space-y-6`}>
            ...
            <div>
                <div className="grid grid-cols-[auto_minmax(0,_1fr)_auto] gap-x-8 gap-y-3">
                    ...
                    <IoTriangleSharp
                        size={26}
                        className="rotate-90 fill-yellow"
                    />
                    <div>
                    ...
                    <IoTriangleSharp
                        size={26}
                        className="rotate-90 fill-purple"
                    />
                    <div>
                    ...
                    <IoTriangleSharp
                        size={26}
                        className="rotate-90 fill-orange"
                    />
                    <div>
        ...
        <FancyRectangle colour="white" offset="16" filled rounded>
            <Paragraph className="space-y-8">
                <ul className="ml-6 list-disc">
                    <li>
                        Need to blow off some steam from a long week of
                        studying?
                    </li>
                    <li>Wanna hang out with like-minded students?</li>
                    <li>
                        Want to beat the final boss on Super Smash Bros? Or do
                        you just want some free food every now and then?
                    </li>
                </ul>
                <p>
                    Come down to the{" "}
                    ...
                    in the Engineering and Maths building for some games!
                </p>
                <p className="font-bold">
                    NOTE: Free food will be provided on the last Friday of every
                    month. One free drink is provided every week.
                </p>
            </Paragraph>
        </FancyRectangle>
    );
