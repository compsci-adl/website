...
export default function StepOne() {
    ...
    const handleSignUp = () => {
        ...
        const authUrl = `${env.NEXT_LOCAL_KEYCLOAK_URL}/realms/cs-club/protocol/openid-connect/registrations?response_type=code&client_id=website&redirect_uri=${redirectUri}&scope=openid+profile+email`;
