    ...
    return (
        <main className="flex flex-col items-center gap-10">
            ...
            <div className="max-w-3xl border-x-4 border-white p-2 text-center text-lg md:p-5 md:text-2xl">
                The <b>University of Adelaide Computer Science Club</b> is
                proudly supported by our <b>generous sponsors</b>. Their
                unwavering support make events and workshops possible, fostering
                an environment for aspiring tech enthusiasts to excel within our
                community.
            </div>
            <Sponsors />
            <Paragraph>
