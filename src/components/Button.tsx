...
export default function Button({ children, className, href, smallShadow, ...props }: ButtonProps) {
    ...
    const smallShadowTopLayer = "max-sm:hover:translate-x-0 max-sm:hover:translate-y-0 max-md:hover:translate-x-[4px] max-md:hover:translate-y-[4px] max-lg:hover:translate-x-[5px] max-lg:hover:translate-y-[5px]";
    const smallShadowBottomLayer = "max-sm:hidden max-md:translate-x-[4px] max-md:translate-y-[4px] max-lg:translate-x-[5px] max-lg:translate-y-[5px]";
