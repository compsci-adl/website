    ...
    return (
        <header className={`${className} fixed z-[9999] w-full`}>
            ...
            <div className="mx-auto mt-8 w-responsive">
                ...
                <div className="relative -right-[0.5rem] -top-[7.5rem] -z-10 h-[8rem] w-responsive border-4 border-black bg-white lg:-top-[6rem] lg:h-[6.5rem] customBreakpointHandler:-top-[4.75rem] customBreakpointHandler:h-[5.25rem]" />
            </div>
        </header>
    );
}
