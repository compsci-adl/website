...
export default function Footer() {
    return (
        <footer className="relative z-20 py-4 bottom-4 border-t-2 border-white flex flex-col md:flex-row md:justify-between md:items-center transition-all duration-500 mx-8 md:mx-24 md:pb-8 font-archivo">
